...
// import CustomizeOptions from '../customizableOptions/main';
...
const CustomizableOptionThree = dynamic(() => import('@/components/Common/customizableOptions/CustomizeOptionThree'), { ssr: false });
...
export default function ConfigurableProductOptionThree({ data, priceFunction }) {
