...
export default function AddToCartV5({ products, className = '' }) {
    ...
    return (
        <button
            className={`py-4 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-[#111111] hover:bg-[#b5876d] text-white cursor-pointer ${className} `}
            disabled={addToCart}
